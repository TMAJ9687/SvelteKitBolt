import { o as onDestroy, c as create_ssr_component, b as add_styles, e as escape, v as validate_component, m as missing_component, d as spread, f as escape_object, g as merge_ssr_styles, h as add_attribute, i as subscribe, j as each } from "../../chunks/ssr.js";
import "firebase/app";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Toaster, "Toaster").$$render($$result, { position: "top-right" }, {}, {})} <div class="min-h-screen flex flex-col">${slots.default ? slots.default({}) : ``}</div>`;
});
export {
  Layout as default
};
